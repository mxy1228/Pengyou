...
public class PullToRefreshListView extends ListView implements OnScrollListener,Runnable{
...
//	private int mStep;
	...
	private void init(Context context){
		...
		View view = LayoutInflater.from(getContext()).inflate(R.layout.pull_fresh_head
				, this.mHeaderView, false);
...
//			Log.d("pengyou", "getLastVisiblePosition = "+getLastVisiblePosition());
//			Log.d("pengyou", "getCount = "+view.getCount());
