...
public class RelationshipRoundImageView extends RelativeLayout {
	...
	public RelationshipRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	...
	public RelationshipRoundImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(){
		...
		if(mSmall){
			this.mWidth = mContext.getResources().getDimensionPixelSize(R.dimen.round_avatar_width);
			this.mHeight = mContext.getResources().getDimensionPixelSize(R.dimen.round_avatar_width);
		}else{
