...
public class SupporterRoundImageView extends RelativeLayout {
	...
	public SupporterRoundImageView(Context context) {
		super(context);
	...
	public SupporterRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	...
	public SupporterRoundImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView(){
		...
		if(mSmall){
			this.mWidth = mContext.getResources().getDimensionPixelSize(R.dimen.support_avatar_width);
			this.mHeight = mContext.getResources().getDimensionPixelSize(R.dimen.support_avatar_height);
		}else{
			this.mWidth = mContext.getResources().getDimensionPixelSize(R.dimen.support_avatar_width);
			this.mHeight = mContext.getResources().getDimensionPixelSize(R.dimen.support_avatar_height);
		}
		...
		addView(mImageView);
		this.mMaskView = new RoundMaskView(mContext,mSmall,mBGColor,1);
