...
public class CircleListHeaderView extends ViewGroup{
	...
	private CircleListView mListViewBase;
	...
	public CircleListHeaderView(Context context,CircleListView listview){
		super(context);
