 ...
 * </pre>
 */
public final class DownloadClient implements HttpClient {
	 ...
	 */
	public static DownloadClient newInstance(String userAgent,
			Context context) {
		...
		return new DownloadClient(manager, params);
	}
	...
	private DownloadClient(ClientConnectionManager ccm, HttpParams params) {
