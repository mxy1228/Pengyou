...
public class ClassifyGameGoodAdapter extends BaseAdapter {
	...
	public ClassifyGameGoodAdapter(Context context, List<GameItem> data) {
...
//	private Map<Integer, View> viewCaches = new HashMap<Integer, View>();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ClassifyGameGoodViewCache viewCache = null;
//		try {
...
//		}
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.classify_game_good_item,
					null);
			viewCache = new ClassifyGameGoodViewCache(convertView);
			convertView.setTag(viewCache);
		} else {
			viewCache = (ClassifyGameGoodViewCache) convertView.getTag();
		}
