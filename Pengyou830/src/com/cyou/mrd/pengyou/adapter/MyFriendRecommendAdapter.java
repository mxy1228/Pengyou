...
public class MyFriendRecommendAdapter extends BaseAdapter implements OnClickListener,AnimationListener{
	...
	public MyFriendRecommendAdapter(Context context,List<RecommendFriendItem> data,Handler handler){
